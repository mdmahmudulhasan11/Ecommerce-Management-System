...
<html lang="en">
    <head>
        ...
        <body>
            ...
            <div class="line2"></div>
            <section class="add-products form-container self">
...
<section class="update-container"> 
    ...
    ?>
                ...
                <form method="POST" enctype="multipart/form-data">
                    <img src="images/<?php echo $fetch_edit['image']; ?>" alt="Product Image">
            ...
            echo "<p>Invalid request. No product selected for editing.</p>";
        }
